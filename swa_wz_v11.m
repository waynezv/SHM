function [V Phi] = swa_wz_v11( k, d, X, tau, varargin )
...
%
    ...
    opt.method        = 'wz';               % Optimization method
...
%                label_name=unique(a);
               ...
               for k=1: kmean_K
                 ...
                 fprintf('saving weight after gk clustering to mat...\n');
                   save weight_gk weight;
                   fprintf('done.\n');
                ...
                matlabpool open 12;
                   ...
                   fprintf('saving Vn after edge detecting, polyfitting to mat...\n');
                   save Vn_gk Vn;
                   fprintf('done.\n');
