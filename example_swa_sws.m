...
F1 = 550e3;             % Maximum frequency [Hz]
F0 = 450e3;             % Minimum frequency [Hz]
...
iterPlot     = true;    % Plot result at each frequency
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
V       =  sparse(VN, Q);
V(:,fn) =  swa( k, dm, Xm(fn,:), tau, 'optMatrix', optMatrix, 'optNomalized', optNomalized, 'plot', iterPlot, 'method', method);
