function [MST_Edge Trans_Dist_Mat Edge_Forest] = MST(Graph_Edge)
[Sort_Col IDX] = sort(Graph_Edge(:, 3)); %col1 & col2 stand for edge vertices; col3 stands for edge weight;
...
MST_Edge = Graph_Edge(idx_SST, 1:3);
