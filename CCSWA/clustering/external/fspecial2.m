...
%     'Dogx'      Derivative of Gaussian along x
%     'Dogy'      Derivative of Gaussian along y
...
type = varargin{1};
type = iptcheckstrs(type,{'gaussian','sobel','prewitt','laplacian', 'Dogx', 'Dogy', 'log',...
...
switch nargin
    ...
    case 2
       ...
       switch type
          ...
          case {'gaussian', 'Dogx', 'Dogy', 'log', 'average'}
              iptcheckinput(p2,{'double'},...
    ...
    case 3
       ...
       % FSPECIAL('Dogx',N,SIGMA)
       % FSPECIAL('Dogy',N,SIGMA)
