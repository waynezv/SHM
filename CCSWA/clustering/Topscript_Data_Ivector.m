...
for k = 1:K
    ...
    % [trans_dist_mat] = max_var_anal(trans_dist_mat, min(2000,size(trans_dist_mat,1)));
    ...
    trans_dist_mat = MSF_Data2(dist_mat{k,1}, 2, 'max');
    tic;
    label_dev_tmp = kmeans(trans_dist_mat, cluster_num{k,1}, 'emptyaction', 'singleton', 'distance', 'cosine');
    ...
    trans_dist_mat = MSF_Data_Pert(dist_mat{k,1}, 30, 0.01);
    tic;
    label_dev_tmp = kmeans(trans_dist_mat, cluster_num{k,1}, 'emptyaction', 'singleton', 'distance', 'cosine');
