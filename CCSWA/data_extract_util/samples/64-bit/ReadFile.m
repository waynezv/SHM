% clc;
% NI_TDM_DLL_Path = '../../dev/bin/64-bit/nilibddc.dll';
NI_TDM_DLL_Path = './data_extract_util/dev/bin/64-bit/nilibddc.dll';
libname = 'nilibddc';
% NI_TDM_H_Path = '../../dev/include/64-bit/nilibddc_m.h';
NI_TDM_H_Path = './data_extract_util/dev/include/64-bit/nilibddc_m.h';
...
%     hold on;
    ...
    data.channel_name = channames;
    data.channel_data = chanvals;
    fprintf('Saving file %s as %s.mat ...\n', Data_Path, file_label);
    save(strcat('./data/mat_files/', file_label), 'data');
